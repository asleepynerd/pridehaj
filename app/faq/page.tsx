...
const faqs: FAQItem[] = [
  {
    ...
    color: "bg-[#FF9B8D] dark:bg-[#FF6B6B]",
    link: "/editor",
  },
  {
  ...
  },
  {
    ...
    color: "bg-[#FFD700] dark:bg-[#FFCA28]",
  },
  {
...
function FAQCard({ item, index }: { item: FAQItem; index: number }) {
  const cardContent = (
    <motion.div
      ...
      className={`${item.color} p-6 rounded-lg shadow-lg transform cursor-pointer dark:text-gray-100`}
      style={{
        maxWidth: "400px",
        minHeight: "200px",
      }}
      ...
      <div className="relative z-10 pt-32 pb-24">
        <div className="container mx-auto px-8">
          <motion.h1
            ...
            className="text-5xl md:text-6xl font-bold text-center mb-20 text-gray-900 dark:text-gray-100"
          >
            FAQ
          </motion.h1>
